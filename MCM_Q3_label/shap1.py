...
shap.plots.force(explainer.expected_value[1], shap_values[1][0], train.drop(columns=['label']).iloc[0],matplotlib=True,show = False)
...
shap.summary_plot(shap_values[1], train.drop(columns=['label']), plot_type="bar")
